...
class justForm(FlaskForm):
    ...
    date_app = DateField('Date', format='%Y-%m-%d')
    tele_no = IntegerField('Telephone No', validators=[DataRequired(message="Please enter a valid number")])
    ...
    mobile_no = IntegerField('Mobile No', validators=[DataRequired(message="Please enter a valid number")])
    email = StringField('Email', validators=[DataRequired(), Email()])
...
class LeaveForm(FlaskForm):
    ...
    leave_cat = SelectField('Leave Category', 
